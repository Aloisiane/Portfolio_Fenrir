...
function updateCarousel(){
    ...
    elements.forEach((element, index) => {
        ...
        element.href = cards[cardIndex].link;
        element.innerHTML = `<img src="${cards[cardIndex].image}" alt="Devoir">`;
    });

    carouselSection.className = "carousel-section " + cards[active].theme;

    document.getElementById("active-title").textContent = cards[active].title;
document.getElementById("active-text").textContent = cards[active].description;
}
